...
cb.cp().process([b for b in bkgd_mod if ("ggZHWW" not in b)]).AddSyst(cb, "tauES", "shape", ch.SystMap()(1.00))
cb.cp().process([b for b in bkgd if (("ZHWW" not in b) and ("ggZHWW" not in b) and ("WZ" not in b))]).AddSyst(cb, "unclMET", "shape", ch.SystMap()(1.00))
