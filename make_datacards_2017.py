...
cb.cp().process(mc_bkgd).AddSyst(cb, "CMS_lumi_13TeV_correlated", "lnN", ch.SystMap()(1.009))
...
cb.cp().process([b for b in bkgd if ("WZ" not in b) and ("ZHWW" not in b)]).AddSyst(cb, "unclMET", "shape", ch.SystMap()(1.00))
cb.cp().process([b for b in bkgd if "WZ" not in b]).AddSyst(cb, "pileup", "shape", ch.SystMap()(1.00))
cb.cp().process([b for b in bkgd if ("WZ" not in b)]).AddSyst(cb, "l1prefire", "shape", ch.SystMap()(1.00))
cb.cp().process([b for b in bkgd if "WZ" not in b]).AddSyst(cb, "eleES", "shape", ch.SystMap()(1.00))
cb.cp().process([b for b in bkgd if "WZ" not in b]).AddSyst(cb, "eleSmear", "shape", ch.SystMap()(1.00))
cb.cp().process([b for b in bkgd if "WZ" not in b]).AddSyst(cb, "muES", "shape", ch.SystMap()(1.00))
